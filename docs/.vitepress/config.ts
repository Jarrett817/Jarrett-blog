...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: [
      {
        text: '前端基础',
        items: getFrontEndSidebar()
      },
      {
        text: '计算机基础',
        items: getComputerBasicSidebar()
      },
      {
        text: '工具',
    ...
    footer: {
      ...
      copyright: 'MIT Licensed | Copyright © 2021-present Jarrett Wang'
    }
  }
});
