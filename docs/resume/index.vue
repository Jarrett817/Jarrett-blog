        ...
        <ol>
          <li>
            ...
            <ul>
              ...
              <li
                >公共技术沉淀：负责部分公共物料、公共组件开发、技术方案输出及公共文档编写、维护</li
              >
            </ul>
            ...
            <ul>
              <li
                ...
                逻辑嵌套的需求；微前端架构下页面多级跳转路径返回的自动化处理插件，解决业务中高频出现的页面跳转问题
              </li>
              <li
                ><strong>技术方案输出：</strong>解决微前端架构下多应用嵌套下的组件库 zIndex
                层级管理问题；axios 封装，支持配置全局 loading、统一处理异常、重复请求
                cancel，提高开发效率
              </li>
              <li
